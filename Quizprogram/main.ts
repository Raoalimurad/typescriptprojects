...
if (questions.ques1 == "QUAID AZAM") {
    console.log(`YOUR ANSWER IS ${questions.ques1} AND RIGHT ANSWER IS QUAID AZAM THAT'S WHY YOU ARE RIGHT`);
    score++;
} else {
    console.log(`YOUR ANSWER IS ${questions.ques1} AND RIGHT ANSWER IS QUAID AZAM THAT'S WHY YOU ARE WRONG`);
};
if (questions.ques2 == "LIAQUAT ALI KHAN") {
    console.log(`YOUR ANSWER IS ${questions.ques2} AND RIGHT ANSWER IS LIAQUAT ALI KHAN THAT'S WHY YOU ARE RIGHT`);
    score++;
} else {
    (console.log(`YOUR ANSWER IS ${questions.ques2} AND RIGHT ANSWER IS LIAQUAT ALI KHAN THAT'S WHY YOU ARE WRONG`));
};
if (questions.ques3 == "ARIF ALVI") {
    (console.log(`YOUR ANSWER IS ${questions.ques3} AND RIGHT ANSWER IS ARIF ALVI THAT'S WHY YOU ARE RIGHT`));
    score++;
} else {
    console.log(`YOUR ANSWER IS ${questions.ques3} AND RIGHT ANSWER IS ARIF ALVI THAT'S WHY YOU ARE WRONG`);
};
if (questions.ques4 == "modi") {
    console.log(`YOUR ANSWER IS ${questions.ques4} AND RIGHT ANSWER IS MODI THAT'S WHY YOU ARE RIGHT`);
    score++;
} else {
